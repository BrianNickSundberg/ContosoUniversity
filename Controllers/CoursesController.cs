...
namespace ContosoUniversity.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CourseID,Title,Credits,DepartmentID,DepartmentName")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CourseID,Title,Credits,DepartmentID,DepartmentName")] Course course)
        {
