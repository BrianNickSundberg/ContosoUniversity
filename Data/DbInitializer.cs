    ...
    public static class DbInitializer
    {
        public static void Initialize(SchoolContext context)
        {
            ...
            var students = new Student[]
            {
                ...
                new Student{FirstMidName="Bill",LastName="Billerson",EnrollmentDate=DateTime.Parse("2005-09-01")},
                new Student{FirstMidName="Steven",LastName="Colbert",EnrollmentDate=DateTime.Parse("2002-09-01")},
                new Student{FirstMidName="Geoff",LastName="Ramsey",EnrollmentDate=DateTime.Parse("2003-09-01")},
                new Student{FirstMidName="Jermey",LastName="Duley",EnrollmentDate=DateTime.Parse("2002-09-01")},
                new Student{FirstMidName="Gavin",LastName="Free",EnrollmentDate=DateTime.Parse("2002-09-01")},
                new Student{FirstMidName="Michael",LastName="Jones",EnrollmentDate=DateTime.Parse("2001-09-01")},
                new Student{FirstMidName="Linsey",LastName="Jones",EnrollmentDate=DateTime.Parse("2003-09-01")},
